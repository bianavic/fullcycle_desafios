...
- O sistema deve receber um input de **8 dígitos** via `POST`, no seguinte formato:
```json
{ "cep": "29902555" }
```
...
- Utilize docker/docker-compose para que possamos realizar os testes de sua aplicação.com CEP não informado